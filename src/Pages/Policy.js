const Policy = () => {
    return (
        <>
            <h1>Privacy Policy for testing adsense</h1>

            <p>At testing adsense, accessible from testing-the-adsense.netlify.app/, one of our main priorities is the
                privacy of our visitors. This Privacy Policy document contains types of information that is collected
                and recorded by testing adsense and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in testing adsense. This policy is not
                applicable to any information collected offline or via channels other than this website. Our Privacy
                Policy was created with the help of the <a href="https://www.freetoolshub.com/">Privacy Policy
                    Generator</a>.</p>
            ...
            <p>testing adsense follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <p>testing adsense's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
            ...
            <p>testing adsense does not knowingly collect any Personal Identifiable Information from children under the
